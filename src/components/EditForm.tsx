...
import { updateComment } from "~/utils/createComment"

export default function EditForm(props: { comment: Comment }) {
  const [text, setText] = createSignal(props.comment.message)
  ...
  return (
    ...
    >
      <textarea
        value={text() || props.comment.message}
